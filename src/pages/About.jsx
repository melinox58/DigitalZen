      ...
      <section className="py-20 md:py-32 px-4 md:px-margin-desktop w-full flex justify-center bg-soft-ivory" id="parcours">
        <div className="max-w-[1280px] w-full flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="col-span-1 md:col-span-2 bg-white/60 backdrop-blur-md rounded-2xl p-8 border border-outline-variant/30 transition-all duration-300 hover:shadow-lg flex flex-col justify-between">
              <div>
            ...
            <div className="col-span-1 bg-primary-container/10 rounded-2xl p-8 border border-primary-container/20 transition-all duration-300 hover:shadow-lg flex flex-col relative overflow-hidden">
            ...
            {/* Card 3: Philosophy */}
            <div className="col-span-1 md:col-span-3 bg-white/70 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/60 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
